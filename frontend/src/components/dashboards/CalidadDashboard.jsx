      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Accidentes Laborales</span>
            <AlertTriangle className="w-5 h-5 text-orange-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">112</div>
          <div className="text-xs text-gray-300">Registrados en 2025</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Reducción PQRs</span>
            <TrendingDown className="w-5 h-5 text-green-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">-28.45%</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Planes de Acción</span>
            <FileCheck className="w-5 h-5 text-blue-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">154</div>
          <div className="text-xs text-gray-300">Ejecutados en 2025</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Auditorías ISO</span>
            <Shield className="w-5 h-5 text-purple-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">14</div>
          <div className="text-xs text-gray-300">Procesos auditados</div>
