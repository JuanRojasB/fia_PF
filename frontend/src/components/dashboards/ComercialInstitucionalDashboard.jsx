...
export default function ComercialInstitucionalDashboard({ data }) {
  ...
  // Extraer datos de ventas Sede 3 por temperatura
  const ventasSede3Temperatura = data?.ventasSede3Temperatura || [];
  
  if (ventasSede3Temperatura.length === 0) {
    return (
      <div className="bg-white/95 backdrop-blur-xl rounded-xl p-12 border border-gray-200 text-center">
        <div className="text-gray-600 text-lg">No hay datos disponibles de Ventas Institucional/Moderno</div>
      </div>
    );
  }
  ...
  const datosTabla = ventasSede3Temperatura.map(v => ({
  ...
  // Calcular ingresos — solo líneas con precio válido
  ...
  // Precio promedio ponderado — números, no strings
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-gray-700 leading-relaxed">
          Análisis de ventas del canal institucional y moderno (Sede 3). Total vendido en 2025: {formatNumber(total2025)} kg, 
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <motion.div
          ...
          onClick={() => openModal(
            'Ingresos Totales 2025 - Canal Institucional (Sede 3)',
            `Ingresos totales en 2025: ${formatCurrency(ingresos2025)}\nVariación vs 2024: ${variacionIngresos}%\n\nQUÉ INCLUYE:\n• Solo Canal Institucional/Moderno - Sede 3\n• Productos refrigerados (100)\n• Productos congelados (105)\n\nNO INCLUYE:\n• Otros canales (Asadero, PDV)\n• Otras sedes\n• Pollo en Pie, Huevos\n\nEste ingreso es MENOR porque solo incluye un canal específico (Institucional/Moderno).\n\nPrecio promedio: ${formatCurrency(precioProm2025)}/kg`
          )}
          className="bg-white/95 backdrop-blur-xl rounded-xl p-6 border-4 border-green-500/30 hover:border-green-500 transition-all cursor-pointer"
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-600 text-sm font-medium">Ingresos Canal Institucional 2025</span>
        ...
        <motion.div
          ...
          onClick={() => openModal(
            ...
            `Precio promedio por kilogramo en 2025: ${formatCurrency(precioProm2025)}/kg. La variación del ${variacionPrecio}% vs 2024 (${formatCurrency(precioProm2024)}/kg) refleja la dinámica de precios del canal institucional y moderno. La diferencia es de ${formatCurrency(Math.abs(precioProm2025 - precioProm2024))}/kg ${parseFloat(variacionPrecio) >= 0 ? 'más' : 'menos'}. Este precio promedio ponderado considera el volumen de ventas de cada línea de producto.`
          )}
          className="bg-white/95 backdrop-blur-xl rounded-xl p-6 border-4 border-purple-500/30 hover:border-purple-500 transition-all cursor-pointer"
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-600 text-sm font-medium">Precio Promedio $/kg Institucional 2025</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-gray-900">Ventas Canal Institucional en Kilos 2024 vs 2025</h3>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-gray-900">Participación Refrigerado vs Congelado Canal Institucional 2025</h3>
            <Info className="w-5 h-5 text-blue-400 animate-pulse" />
          </div>
