    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <motion.div
          ...
          className="bg-slate-800/50 backdrop-blur-xl rounded-xl p-5 border-4 border-blue-500/30 hover:border-blue-500 transition-all cursor-pointer"
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Total Compras 2025</span>
            <ShoppingCart className="w-5 h-5 text-blue-400" />
          </div>
          <div className="text-3xl font-bold text-white mb-1">{formatCurrency(totales.total2025)}</div>
          <div className="text-xs text-gray-300">Compras totales</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Crecimiento 2025</span>
            <TrendingUp className="w-5 h-5 text-green-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">+{totales.variacion2025vs2024}%</div>
          <div className="text-xs text-gray-300">vs 2024</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Ajuste 2024</span>
            <TrendingDown className="w-5 h-5 text-orange-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">{totales.variacion2024vs2023}%</div>
          <div className="text-xs text-gray-300">vs 2023</div>
        ...
        <motion.div
          ...
          className="bg-slate-800/50 backdrop-blur-xl rounded-xl p-5 border-4 border-purple-500/30 hover:border-purple-500 transition-all cursor-pointer"
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Promedio Mensual</span>
            <DollarSign className="w-5 h-5 text-purple-400" />
          </div>
          <div className="text-3xl font-bold text-white mb-1">{formatCurrency(totales.total2025 / 12)}</div>
          <div className="text-xs text-gray-300">Por mes 2025</div>
