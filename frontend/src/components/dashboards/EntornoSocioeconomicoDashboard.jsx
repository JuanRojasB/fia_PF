  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="relative overflow-hidden bg-gradient-to-br from-cyan-600/20 via-blue-600/20 to-indigo-600/20 backdrop-blur-xl rounded-2xl p-8 lg:p-12 border-2 border-cyan-500/30"
      >
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-xl text-cyan-300">Indicadores Económicos de Colombia</p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-white">Indicadores Económicos</h2>
        </div>

        <div className="space-y-8">
          {/* PIB Chart */}
          <div className="rounded-xl overflow-hidden border-2 border-blue-500/30 bg-slate-900/50 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-bold text-white text-center mb-4 sm:mb-6">
            ...
            <div className="mt-6 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
              {pibLegend.map((item) => (
                <div key={item.letra} className="flex items-center gap-2 text-gray-300">
                  <span className="font-bold text-blue-400">{item.letra}:</span>
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <p className="text-sm text-gray-300 leading-relaxed">
                <span className="font-semibold text-blue-400">Cómo leer esta gráfica:</span> Cada letra (A-L) representa un trimestre desde 2023 periodo-I hasta 2025 periodo-IV. 
          ...
          <div className="rounded-xl overflow-hidden border-2 border-green-500/30 bg-slate-900/50 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-bold text-white text-center mb-4 sm:mb-6">
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <p className="text-sm text-gray-300 leading-relaxed">
                <span className="font-semibold text-green-400">Cómo leer esta gráfica:</span> Esta gráfica compara las tasas de crecimiento de diferentes sectores económicos en tres períodos: 
          ...
          {/* IPC Colombia Chart */}
          <div className="rounded-xl overflow-hidden border-2 border-purple-500/30 bg-slate-900/50 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-bold text-white text-center mb-4 sm:mb-6">
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <p className="text-sm text-gray-300 leading-relaxed">
                <span className="font-semibold text-purple-400">Cómo leer esta gráfica:</span> El Índice de Precios al Consumidor (IPC) mide la variación de precios de bienes y servicios. 
          ...
          <div className="rounded-xl overflow-hidden border-2 border-cyan-500/30 bg-slate-900/50 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-bold text-white text-center mb-4 sm:mb-6">
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <p className="text-sm text-gray-300 leading-relaxed">
                <span className="font-semibold text-cyan-400">Cómo leer esta gráfica:</span> La TRM (Tasa Representativa del Mercado) muestra el valor promedio anual del dólar en pesos colombianos. 
                ...
                cayendo el <span className="font-semibold text-red-400">-9.21%</span> de 2023 a la fecha.
              </p>
            </div>
            
            {/* Nota adicional */}
            <div className="mt-4 p-4 rounded-lg bg-cyan-900/20 border border-cyan-500/30">
              <div className="space-y-2">
                ...
                <p className="text-sm text-cyan-200 mt-3 pt-3 border-t border-cyan-700">
          ...
          <div className="rounded-xl overflow-hidden border-2 border-teal-500/30 bg-slate-900/50 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-bold text-white text-center mb-4 sm:mb-6">
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <p className="text-sm text-gray-300 leading-relaxed">
                <span className="font-semibold text-teal-400">Cómo leer esta gráfica:</span> El precio del pollo en el año 2025-2024 
            ...
            <div className="mt-4 p-4 rounded-lg bg-teal-900/20 border border-teal-500/30">
              <div className="space-y-2">
                ...
                <p className="text-sm text-teal-200 mt-3 pt-3 border-t border-teal-700">
          ...
          <div className="rounded-xl overflow-hidden border-2 border-rose-500/30 bg-slate-900/50 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-bold text-white text-center mb-4 sm:mb-6">
            ...
            <div className="mt-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <p className="text-sm text-gray-300 leading-relaxed">
                <span className="font-semibold text-rose-400">Cómo leer esta gráfica:</span> Esta gráfica muestra tres indicadores clave del mercado laboral colombiano:
                <br/><br/>
                • <span className="text-red-400 font-semibold">TGP (línea roja)</span>: Tasa Global de Participación - porcentaje de la población en edad de trabajar que participa activamente en el mercado laboral.
                <br/>
                • <span className="text-orange-400 font-semibold">TO (línea naranja)</span>: Tasa de Ocupación - porcentaje de la población en edad de trabajar que está empleada.
                <br/>
                • <span className="text-gray-400 font-semibold">TD (línea gris)</span>: Tasa de Desocupación - porcentaje de la población económicamente activa que está desempleada.
              </p>
            </div>
            
            {/* Nota adicional */}
            <div className="mt-4 p-4 rounded-lg bg-rose-900/20 border border-rose-500/30">
              <div className="space-y-2">
                <h4 className="text-base font-semibold text-rose-300 mb-3">Análisis de Desempleo</h4>
          ...
          <div className="rounded-xl overflow-hidden border-2 border-amber-500/30 bg-slate-900/50 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-bold text-white text-center mb-4 sm:mb-6">
            ...
            <div className="mb-6 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <p className="text-sm text-gray-300 leading-relaxed">
                La producción de carne pollo en el 2025 fue de <span className="font-semibold text-amber-400">2.003.000 de toneladas</span> presentando 
                un crecimiento de <span className="font-semibold text-green-400">9%</span> frente a <span className="font-semibold">1.836.032 del 2024</span> lo 
                que se tradujo en un incremento en el consumo per cápita de <span className="font-semibold text-amber-400">2.7%</span> pasado 
                de <span className="font-semibold">36.8 kilos en 2024</span> a <span className="font-semibold text-amber-400">37.8 kilos en 2025</span>. 
                En el caso de huevo el consumo per cápita creció pasando de <span className="font-semibold">342 a 366 huevos</span> siendo 
                un crecimiento de <span className="font-semibold text-green-400">7%</span> y la producción paso <span className="font-semibold">18.019 millones de huevos</span> a 
                <span className="font-semibold text-amber-400"> 19.402</span> que corresponde a <span className="font-semibold text-green-400">+7.6%</span>. 
                El sector presentó un crecimiento en el 2025 de <span className="font-semibold text-green-400">6.3 Puntos porcentuales</span> respecto al 2024.
              </p>
            </div>

            {/* Título de Costos */}
            <h4 className="text-lg font-bold text-white mb-4">Costos materia prima esencial</h4>
            ...
            <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <h5 className="text-base font-semibold text-amber-400 mb-3">Análisis de Precios de Granos</h5>
              <p className="text-sm text-gray-300 leading-relaxed mb-3">
                De 2019 a 2023 precios bajos y estables, <span className="font-semibold text-red-400">2021-2022</span> fuerte incremento alcanzando punto 
                ...
                <span className="font-semibold text-green-400"> 2023-2024</span> el maíz <span className="font-semibold">200 US $/t</span> y la soya caen 
                <span className="font-semibold"> 400-450 US $/t</span>, y en <span className="font-semibold text-amber-400">2025</span> el maíz 
          ...
          <div className="rounded-xl overflow-hidden border-2 border-sky-500/30 bg-slate-900/50 p-4 sm:p-6">
            ...
            <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700">
              <p className="text-sm text-gray-300 leading-relaxed">
                <span className="font-semibold text-sky-400">Análisis:</span> Los precios de materias primas para el ABA a nivel nacional presentan 
                una tendencia al alza desde el año 2023 creciendo el <span className="font-semibold text-green-400">22%</span> a 2026.
              </p>
            </div>
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-sky-900/20 border border-sky-500/30">
                <h6 className="text-sm font-semibold text-sky-300 mb-2">Maíz Amarillo</h6>
                <div className="space-y-1 text-xs text-gray-300">
                  ...
                  <p>2026: <span className="font-semibold text-sky-400">1,904</span></p>
                </div>
              </div>

              <div className="p-4 rounded-lg bg-blue-900/20 border border-blue-500/30">
                <h6 className="text-sm font-semibold text-blue-300 mb-2">Soya Grano</h6>
                <div className="space-y-1 text-xs text-gray-300">
                  ...
                  <p>2026: <span className="font-semibold text-blue-400">1,923</span></p>
                </div>
              </div>

              <div className="p-4 rounded-lg bg-indigo-900/20 border border-indigo-500/30">
                <h6 className="text-sm font-semibold text-indigo-300 mb-2">Torta de Soya</h6>
                <div className="space-y-1 text-xs text-gray-300">
                  <p>2023: <span className="font-semibold">1,133</span></p>
                  <p>2024: <span className="font-semibold">1,248</span></p>
                  <p>2025: <span className="font-semibold">1,313</span></p>
                  <p>2026: <span className="font-semibold text-indigo-400">1,382</span></p>
                </div>
              </div>
            </div>
          </div>
