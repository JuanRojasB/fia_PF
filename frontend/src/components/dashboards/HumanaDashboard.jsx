  ...
  return (
    <div className="space-y-4">
      ...
      <Section title="Planta de Personal" color="#3b82f6" icon={Users} defaultOpen={true}>
        <KpiRow items={[
          { label: 'Planta dic. 2025', value: '840', sub: '+10 vs dic. 2024 (830)', color: '#3b82f6', trend: 'up', upIsGood: true },
          { label: 'Crecimiento neto', value: '+1,20%', sub: 'Crecimiento moderado y sostenible', color: '#10b981', trend: 'up', upIsGood: true },
          { label: 'Costo por persona/mes', value: '$4.166.567', sub: '$41.978.924.466 ÷ 840 ÷ 12', color: '#6366f1', trend: 'up', upIsGood: false },
          { label: 'Costo nómina/planta', value: '+13,35%', sub: 'Nómina creció más que la planta', color: '#ef4444', trend: 'up', upIsGood: false },
        ]} />
      ...
      <Section title="Costo de Nómina" color="#10b981" icon={DollarSign}>
        <KpiRow items={[
          { label: 'Costo nómina 2025', value: '$41.978.924.466', sub: '+$5.381.580.637 vs 2024', color: '#10b981', trend: 'up', upIsGood: false },
          { label: 'Variación anual', value: '+14,70%', sub: 'Supera inflación 2025 (5,10%)', color: '#ef4444', trend: 'up', upIsGood: false },
          { label: 'Incremento real', value: '+9,6pp', sub: 'Por encima de la inflación', color: '#f97316', trend: 'up', upIsGood: false },
          { label: 'Costo adicional', value: '$5.381.580.637', sub: 'Horas diurnas + primas antigüedad', color: '#6b7280', trend: 'neutral' },
        ]} />
        <p className="text-sm text-gray-700 pt-3 leading-relaxed">
          El costo total de la nómina pasó de <strong>$36.597.343.829</strong> en 2024 a <strong>$41.978.924.466</strong> en 2025, con una variación del <strong className="text-red-600">14,70% (+$5.381.580.637)</strong>. El aumento obedece principalmente a:
        </p>
      ...
      <Section title="Costo de Horas Extras" color="#8b5cf6" icon={Clock}>
        <KpiRow items={[
          { label: 'Horas extras 2025', value: '130.890', sub: '+3.691 horas vs 2024', color: '#8b5cf6', trend: 'up', upIsGood: false },
          { label: 'Crecimiento horas', value: '+2,90%', sub: 'Volumen moderado', color: '#6b7280', trend: 'up', upIsGood: false },
          { label: 'Costo total 2025', value: '$1.286.579.002', sub: '+$220.921.887 vs 2024', color: '#ef4444', trend: 'up', upIsGood: false },
          { label: 'Costo/hora promedio', value: '+17,32%', sub: 'Reforma laboral + jornada reducida', color: '#dc2626', trend: 'up', upIsGood: false },
        ]} />
        <p className="text-sm text-gray-700 pt-3 leading-relaxed">
  ...
  return (
    <div className="space-y-4">
      ...
      <Section title="Rotación de Personal" color="#ef4444" icon={UserMinus} defaultOpen={true}>
        <KpiRow items={[
          { label: 'Tasa de retiros 2025', value: '66,9%', sub: '562 retiros ÷ 840 planta', color: '#ef4444', trend: 'up', upIsGood: false },
          { label: 'Retiros vs 2024', value: '+5,24%', sub: '534 → 562 (+28 personas)', color: '#f97316', trend: 'up', upIsGood: false },
          { label: 'Ingresos vs 2024', value: '+6,02%', sub: '532 → 564 (+32 personas)', color: '#10b981', trend: 'up', upIsGood: true },
          { label: 'Balance neto', value: '+4', sub: 'Ingresos superan retiros en 4', color: '#3b82f6', trend: 'up', upIsGood: true },
        ]} />
  ...
  return (
    <div className="space-y-4">
      ...
      <Section title="Causas de Desvinculación" color="#0891b2" icon={UserMinus} defaultOpen={true}>
        <KpiRow items={[
          { label: 'Renuncia voluntaria', value: '84%', sub: '471 de 562 retiros — señal de alerta', color: '#ef4444', trend: 'up', upIsGood: false },
          { label: 'Terminaciones contrato', value: '12%', sub: '66 personas (SENA + causa)', color: '#f97316', trend: 'neutral' },
          { label: 'Período de prueba', value: '3%', sub: '15 personas — revisar selección', color: '#eab308', trend: 'up', upIsGood: false },
          { label: 'Causas marginales', value: '1%', sub: 'Pensión, fallecimiento, mutuo acuerdo', color: '#94a3b8', trend: 'neutral' },
        ]} />
        <p className="text-sm text-gray-700 pt-3 leading-relaxed">
        ...
        <CollapsibleTable title="Detalle por motivo de retiro — 562 personas" defaultOpen={false}>
          <table className="w-full text-sm border-collapse">
            <thead>
  ...
  return (
    <div className="space-y-4">
      ...
      <Section title="Impacto Salario Mínimo" color="#f59e0b" icon={TrendingUp} defaultOpen={true}>
        <KpiRow items={[
          { label: 'SMLV 2026', value: '$1.750.905', sub: '+23,0% vs 2025 — mayor alza reciente', color: '#ef4444', trend: 'up', upIsGood: false },
          { label: 'SMLV 2025', value: '$1.423.500', sub: '+9,5% vs 2024', color: '#f59e0b', trend: 'up', upIsGood: false },
          { label: 'Brecha SMLV vs inflación', value: '+17,65pp', sub: '2026: SMLV 23% vs inflación 5,35%', color: '#dc2626', trend: 'up', upIsGood: false },
          { label: 'PTF 2025', value: '0,91%', sub: 'Productividad por debajo del alza salarial', color: '#6b7280', trend: 'neutral' },
        ]} />
