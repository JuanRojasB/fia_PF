    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="text-4xl font-bold text-white mb-1">{formatNumber(kpis.personal2025)}</div>
          <div className="flex items-center gap-2 text-xs">
            <span className="text-gray-400">2024: {formatNumber(kpis.personal2024)}</span>
            <span className={`flex items-center ${kpis.variacionPersonal >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        >
          ...
          <div className="text-2xl font-bold text-white mb-1">{formatCurrency(kpis.nomina2025)}</div>
          <div className="flex items-center gap-2 text-xs">
            <span className="text-gray-400">2024: {formatCurrency(kpis.nomina2024)}</span>
            <span className={`flex items-center ${kpis.variacionNomina >= 0 ? 'text-orange-400' : 'text-green-400'}`}>
        ...
        >
          ...
          <div className="text-4xl font-bold text-white mb-1">{formatNumber(kpis.retiros2025)}</div>
          <div className="flex items-center gap-2 text-xs">
            <span className="text-gray-400">2024: {formatNumber(kpis.retiros2024)}</span>
            <span className={`flex items-center ${kpis.variacionRetiros >= 0 ? 'text-red-400' : 'text-green-400'}`}>
        ...
        >
          ...
          <div className="text-4xl font-bold text-white mb-1">{formatNumber(kpis.ingresos2025)}</div>
          <div className="flex items-center gap-2 text-xs">
            <span className="text-gray-400">2024: {formatNumber(kpis.ingresos2024)}</span>
            <span className={`flex items-center ${kpis.variacionIngresos >= 0 ? 'text-green-400' : 'text-red-400'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-sm font-medium">Horas Extras</span>
            <Clock className="w-6 h-6 text-cyan-400" />
          </div>
          <div className="text-3xl font-bold text-white mb-1">{formatNumber(kpis.horas2025)}</div>
          <div className="flex items-center gap-2 text-xs">
            <span className="text-gray-400">2024: {formatNumber(kpis.horas2024)}</span>
            <span className={`flex items-center ${kpis.variacionHoras >= 0 ? 'text-orange-400' : 'text-green-400'}`}>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-sm font-medium">Costo Horas Extras</span>
            <DollarSign className="w-6 h-6 text-orange-400" />
          </div>
          <div className="text-2xl font-bold text-white mb-1">{formatCurrency(kpis.valorHoras2025)}</div>
          <div className="flex items-center gap-2 text-xs">
            <span className="text-gray-400">2024: {formatCurrency(kpis.valorHoras2024)}</span>
            <span className={`flex items-center ${kpis.variacionValorHoras >= 0 ? 'text-red-400' : 'text-green-400'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-white">Evolución de Costos de Nómina</h3>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gradient-to-br from-red-500/20 to-red-600/10 rounded-lg p-4 border border-red-500/30 h-[90px]">
                <div className="flex items-center justify-between h-full">
                  <div>
                    <div className="text-xs text-gray-400 mb-1">Retiros</div>
              ...
              <div className="bg-slate-700/50 rounded-lg p-3 border border-slate-600 text-center h-[70px] flex flex-col justify-center">
                <div className="text-xs text-gray-400 mb-1">Saldo Neto</div>
