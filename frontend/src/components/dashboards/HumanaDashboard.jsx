    ...
    <div className="space-y-4">
      ...
      <Section title="Planta de Personal" color="#3b82f6" icon={Users} defaultOpen={true}>
        <KpiRow items={[
          ...
          { label: 'Costo por persona/mes', value: '$4,17M', sub: '$41.979M ÷ 840 ÷ 12', color: '#6366f1', trend: 'up', upIsGood: false },
      ...
      <Section title="Costo de Nómina" color="#10b981" icon={DollarSign}>
        <KpiRow items={[
          { label: 'Costo nómina 2025', value: '$41.979M', sub: '+$5.382M vs 2024', color: '#10b981', trend: 'up', upIsGood: false },
          ...
          { label: 'Costo adicional', value: '$5.382M', sub: 'Horas diurnas + primas antigüedad', color: '#6b7280', trend: 'neutral' },
        ]} />
        <p className="text-sm text-gray-700 pt-3 leading-relaxed">
      ...
      <Section title="Costo de Horas Extras" color="#8b5cf6" icon={Clock}>
        <KpiRow items={[
          ...
          { label: 'Costo total 2025', value: '$1.287M', sub: '+$221M vs 2024', color: '#ef4444', trend: 'up', upIsGood: false },
