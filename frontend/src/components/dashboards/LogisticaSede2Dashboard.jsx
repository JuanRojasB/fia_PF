    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <motion.div
          ...
          onClick={() => openModal(
            'Gastos Totales 2025',
            `Total de gastos operacionales logísticos Sede 2 para 2025: ${formatCurrency(total2025)}. El incremento del ${variacionTotal}% vs 2024 está justificado por el crecimiento en ventas del 30.42% y la incorporación de nuevos clientes como ARA y D1.`
          )}
      ...
      >
        ...
        <div className="mt-6 bg-green-500/10 border border-green-500/30 rounded-lg p-4">
          <p className="text-sm text-gray-300 leading-relaxed">
            <span className="font-semibold text-white">Análisis Sede 2:</span> El incremento del 14.37% en gastos totales está justificado por el crecimiento 
            en ventas del 30.42%. Los principales incrementos se deben al aumento en arriendos y congelación (43%) por el traslado del cliente D1, y el incremento 
            en fletes (24.29%) por la implementación de rutas nacionales para los clientes ARA y D1. El ingreso de 9 personas para atender la nueva línea de 
            negociación del cliente ARA explica el aumento en personal de postproceso (13.65%).
          </p>
        </div>
      </motion.div>
