      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Retorno de Inversión</span>
            <TrendingUp className="w-5 h-5 text-green-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">17.4%</div>
          <div className="text-xs text-gray-300">ROI Promedio 2025</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Campañas BTL</span>
            <Target className="w-5 h-5 text-orange-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">82%</div>
          <div className="text-xs text-gray-300">Efectividad Lograda</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Ejecución Presupuestal</span>
            <DollarSign className="w-5 h-5 text-blue-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">83.7%</div>
          <div className="text-xs text-gray-300">$401.7M de $480M</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Pauta Digital</span>
            <Zap className="w-5 h-5 text-purple-400" />
          </div>
          <div className="text-3xl font-bold text-white mb-1">CTR 2.7%</div>
          <div className="text-xs text-gray-300">Costo por Clic: $248</div>
