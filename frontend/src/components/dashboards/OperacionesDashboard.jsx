    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <motion.div
          ...
          className="bg-slate-800/50 backdrop-blur-xl rounded-xl p-5 border-4 border-green-500/30 hover:border-green-500 transition-all cursor-pointer"
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">OEE Global 2025</span>
            <Activity className="w-5 h-5 text-green-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">86,4%</div>
          <div className="text-xs text-gray-300">Meta: 86% ✓</div>
        ...
        <motion.div
          ...
          className="bg-slate-800/50 backdrop-blur-xl rounded-xl p-5 border-4 border-orange-500/30 hover:border-orange-500 transition-all cursor-pointer"
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">Disponibilidad</span>
            <TrendingDown className="w-5 h-5 text-orange-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">95,70%</div>
          <div className="text-xs text-gray-300">2025</div>
        ...
        <motion.div
          ...
          className="bg-slate-800/50 backdrop-blur-xl rounded-xl p-5 border-4 border-red-500/30 hover:border-red-500 transition-all cursor-pointer"
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">MTBF</span>
            <AlertTriangle className="w-5 h-5 text-red-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">10,42 hrs</div>
          <div className="text-xs text-gray-300">Tiempo entre fallas</div>
        ...
        <motion.div
          ...
          className="bg-slate-800/50 backdrop-blur-xl rounded-xl p-5 border-4 border-yellow-500/30 hover:border-yellow-500 transition-all cursor-pointer"
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-xs font-medium">MTTR</span>
            <Clock className="w-5 h-5 text-yellow-400" />
          </div>
          <div className="text-4xl font-bold text-white mb-1">0,47 hrs</div>
          <div className="text-xs text-gray-300">Tiempo de reparación</div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-2xl font-bold text-white">Equipos Críticos - 104,30 hrs de Paro</h3>
            <p className="text-sm text-gray-400 mt-1">Top 5 equipos con mayor impacto en producción 2025</p>
          </div>
          <button onClick={() => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          <div className="bg-gradient-to-br from-red-500/20 to-red-600/10 rounded-xl p-4 border-2 border-red-500/30">
            ...
            <div className="text-xs text-gray-400">22 eventos</div>
          ...
          <div className="bg-gradient-to-br from-orange-500/20 to-orange-600/10 rounded-xl p-4 border-2 border-orange-500/30">
            ...
            <div className="text-xs text-gray-400">23 eventos</div>
          ...
          <div className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/10 rounded-xl p-4 border-2 border-yellow-500/30">
            ...
            <div className="text-xs text-gray-400">42 eventos</div>
          ...
          <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/10 rounded-xl p-4 border-2 border-blue-500/30">
            ...
            <div className="text-xs text-gray-400">17 eventos</div>
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/10 rounded-xl p-4 border-2 border-purple-500/30">
            ...
            <div className="text-xs text-gray-400">20 eventos</div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-xl font-bold text-white">Disponibilidad y OEE Mensual 2025</h3>
            <p className="text-xs text-gray-400 mt-1">Meta OEE: 86% • Verde: Disponibilidad • Azul: OEE</p>
          </div>
          <button onClick={() => {
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-xl font-bold text-white">Órdenes de Trabajo 2025 - Enfoque Preventivo</h3>
            <p className="text-xs text-gray-400 mt-1">Verde: Preventivas (3.807) • Rojo: Correctivas (456) • Total: 4.263 OT</p>
          </div>
          <button onClick={() => {
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-xl font-bold text-white">Mantenimiento de Vehículos</h3>
            <p className="text-sm text-gray-400 mt-1">Ahorro de $166M (-46,65%) vs 2024</p>
          </div>
          <button onClick={() => openModal('Costos de Vehículos', 'Se observa una reducción de $166.084.545 respecto al año anterior, aunque cabe notar que los datos de diciembre 2025 aún no están contabilizados. Vehículo SPS-047 fue el vehículo con el costo más alto en el año. En el mes de abril 2025 se cambió sistema hidráulico de dirección y la caja de este sistema. Esta reducción del 46,65% representa una gestión eficiente de mantenimiento vehicular.')} className="p-2 hover:bg-slate-700 rounded-lg transition-colors">
            <Info className="w-6 h-6 text-gray-400" />
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {mantenimientoVehiculos.map((mv, idx) => (
            <div key={idx} className={`bg-gradient-to-br ${idx === 0 ? 'from-orange-500/20 to-orange-600/10 border-orange-500/30' : 'from-green-500/20 to-green-600/10 border-green-500/30'} rounded-xl p-5 border-2`}>
              ...
              <div className="text-xs text-gray-400">Costo total mantenimiento</div>
              {mv.variacion_pct && (
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">Arquitectura vs Mantenimiento por sede</p>
          </div>
          <button onClick={() => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {datosNovedadesArea.map((area, idx) => (
            <div key={idx} className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 rounded-xl p-5 border border-slate-600">
