      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-sm">Total Aves 2025</span>
            <Factory className="w-5 h-5 text-blue-400" />
          </div>
          <div className="text-3xl font-bold text-white">{(totales.totalAves2025 / 1000000).toFixed(2)}M</div>
          <div className="text-sm text-gray-400 mt-1">Aves procesadas</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-sm">Peso Promedio 2025</span>
            <Activity className="w-5 h-5 text-green-400" />
          </div>
          <div className="text-3xl font-bold text-white">{totales.promedioPeso2025}g</div>
          <div className="text-sm text-gray-400 mt-1">Por ave</div>
          <div className="mt-3 pt-3 border-t border-slate-700">
            <div className="text-xs text-gray-500">vs 2024</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-sm">Merma Planta 2025</span>
            <TrendingDown className="w-5 h-5 text-green-400" />
          </div>
          <div className="text-3xl font-bold text-white">5,38%</div>
          <div className="text-sm text-gray-400 mt-1">Reducción de merma</div>
          <div className="mt-3 pt-3 border-t border-slate-700">
            <div className="text-xs text-gray-500">vs 2024</div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-400 text-sm">Canal + Víscera</span>
            <Award className="w-5 h-5 text-purple-400" />
          </div>
          <div className="text-3xl font-bold text-white">94,68%</div>
          <div className="text-sm text-gray-400 mt-1">Participación 2025</div>
          <div className="mt-3 pt-3 border-t border-slate-700">
            <div className="text-xs text-gray-500">vs 2024</div>
