        ...
        <>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">INDICADORES TÉCNICOS - GRANJAS AVES (POLLO DE ENGORDE)</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 text-sm">Conversión Alimenticia</span>
                  <Target className="w-5 h-5 text-cyan-400" />
                </div>
                <div className="text-3xl font-bold text-white">{formatDecimal(conversionPollo)}</div>
                <div className="text-sm text-gray-400 mt-1">kg alimento/kg carne</div>
                <div className={`mt-3 pt-3 border-t border-slate-700 text-xs ${conversionPollo <= 1.8 ? 'text-green-400' : 'text-orange-400'}`}>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 text-sm">Mortalidad</span>
                  <AlertTriangle className="w-5 h-5 text-red-400" />
                </div>
                <div className="text-3xl font-bold text-white">{formatDecimal(mortalidadPollo)}%</div>
                <div className="text-sm text-gray-400 mt-1">Tasa de mortalidad</div>
                <div className={`mt-3 pt-3 border-t border-slate-700 text-xs ${mortalidadPollo < 5 ? 'text-green-400' : 'text-red-400'}`}>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 text-sm">Peso Promedio</span>
                  <Award className="w-5 h-5 text-yellow-400" />
                </div>
                <div className="text-3xl font-bold text-white">{formatDecimal(pesoPromedioPollo, 2)}</div>
                <div className="text-sm text-gray-400 mt-1">kg por ave</div>
                <div className={`mt-3 pt-3 border-t border-slate-700 text-xs ${pesoPromedioPollo >= 2.4 && pesoPromedioPollo <= 2.6 ? 'text-green-400' : 'text-orange-400'}`}>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 text-sm">Días de Engorde</span>
                  <TrendingUp className="w-5 h-5 text-orange-400" />
                </div>
                <div className="text-3xl font-bold text-white">{formatDecimal(diasEngordePollo)}</div>
                <div className="text-sm text-gray-400 mt-1">días promedio</div>
                <div className={`mt-3 pt-3 border-t border-slate-700 text-xs ${diasEngordePollo >= 42 && diasEngordePollo <= 45 ? 'text-green-400' : 'text-orange-400'}`}>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-400 text-sm">Índice Productivo</span>
                  <Zap className="w-5 h-5 text-purple-400" />
                </div>
                <div className="text-3xl font-bold text-white">{formatDecimal(efiAlimPollo)}</div>
                <div className="text-sm text-gray-400 mt-1">IP (Eficiencia)</div>
                <div className={`mt-3 pt-3 border-t border-slate-700 text-xs ${efiAlimPollo > 300 ? 'text-green-400' : efiAlimPollo > 250 ? 'text-yellow-400' : 'text-red-400'}`}>
          ...
          {zootecniaPollo.length >= 2 && (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <Activity className="w-8 h-8 text-cyan-400" />
                <h2 className="text-2xl font-bold text-white">COMPARATIVO DATOS ZOOTÉCNICOS GRANJAS AVES 2025-2024</h2>
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b-2 border-cyan-600">
                      <th className="text-left py-3 px-4 text-gray-300 font-bold bg-cyan-900/30">INDICADOR</th>
                      ...
                      return (
                        <>
                          ...
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">POLLO ENCASETADO</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatNumber(actual.pollo_encasetado)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatNumber(anterior.pollo_encasetado)}</td>
                          ...
                          <tr className="border-b-2 border-green-600 bg-green-900/10 hover:bg-green-900/20 transition-colors">
                            ...
                            <td className="py-3 px-4 text-right text-gray-400">{formatNumber(anterior.pollo_procesado)}</td>
                          ...
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">MORTALIDAD ACUMULADA</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatNumber(actual.mortalidad_acumulada)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatNumber(anterior.mortalidad_acumulada)}</td>
                          ...
                          {/* Mortalidad % */}
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">MORTALIDAD %</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatDecimal(actual.mortalidad_pct)}%</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.mortalidad_pct)}%</td>
                          ...
                          {/* Peso Esperado */}
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">PESO ESPERADO (kg)</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatDecimal(actual.peso_esperado, 3)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.peso_esperado, 3)}</td>
                          ...
                          {/* Peso Promedio */}
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">PESO PROMEDIO (kg)</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatDecimal(actual.peso_promedio, 3)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.peso_promedio, 3)}</td>
                          ...
                          {/* DSG */}
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">DSG (Desviación Estándar Ganancia)</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatDecimal(actual.dsg)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.dsg)}</td>
                          ...
                          <tr className="border-b-2 border-cyan-600 bg-cyan-900/10 hover:bg-cyan-900/20 transition-colors">
                            ...
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.conversion)}</td>
                          ...
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">KG. ALIMENTO CONSUMIDO</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatNumber(actual.kg_alimento_consumido)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatNumber(anterior.kg_alimento_consumido)}</td>
                          ...
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">CONSUMO ALIMENTO X POLLO (kg)</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatDecimal(actual.consumo_alimento_x_pollo)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.consumo_alimento_x_pollo)}</td>
                          ...
                          <tr className="border-b-2 border-purple-600 bg-purple-900/10 hover:bg-purple-900/20 transition-colors">
                            ...
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.efi_alim_ip)}</td>
                          ...
                          {/* Valor Kg Alimento */}
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">VALOR KG. ALIMENTO ($)</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatDecimal(actual.vr_kg_alimento)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.vr_kg_alimento)}</td>
                          ...
                          {/* Kg Pollo Procesado */}
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">KG. POLLO PROCESADO</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatNumber(actual.kg_pollo_procesado)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatNumber(anterior.kg_pollo_procesado)}</td>
                          ...
                          <tr className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
                            <td className="py-3 px-4 text-white font-semibold">DÍAS PROMEDIO ENGORDE</td>
                            <td className="py-3 px-4 text-right text-blue-400 font-bold">{formatDecimal(actual.dias_promedio_engorde)}</td>
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.dias_promedio_engorde)}</td>
                          ...
                          <tr className="border-b-2 border-orange-600 bg-orange-900/10 hover:bg-orange-900/20 transition-colors">
                            ...
                            <td className="py-3 px-4 text-right text-gray-400">{formatDecimal(anterior.dias_ciclo)}</td>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            >
              <h3 className="text-xl font-bold text-white mb-2">Conversión Alimenticia 2024 vs 2025</h3>
              <p className="text-sm text-gray-400 mb-6">kg alimento / kg carne (menor es mejor)</p>
              <ResponsiveContainer width="100%" height={400}>
                <ComposedChart data={datosPolloChart} margin={{ left: 20, right: 20 }}>
                  ...
                  <Tooltip 
                    ...
                    formatter={(value) => [formatDecimal(value), 'Conversión']}
                  />
                  <Legend />
            ...
            >
              <h3 className="text-xl font-bold text-white mb-2">Mortalidad % y Peso Promedio</h3>
              <p className="text-sm text-gray-400 mb-6">Indicadores de sanidad y calidad</p>
              <ResponsiveContainer width="100%" height={400}>
                <ComposedChart data={datosPolloChart} margin={{ left: 20, right: 20 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#374151" />
                  <XAxis dataKey="anio" stroke="#9ca3af" />
                  ...
                  <Tooltip 
                    ...
                    formatter={(value, name) => {
                      if (name === 'Mortalidad %') return [formatDecimal(value) + '%', name];
                      if (name === 'Peso Promedio') return [formatDecimal(value, 2) + ' kg', name];
            ...
            >
              <h3 className="text-xl font-bold text-white mb-2">Pollo Procesado 2024 vs 2025</h3>
              <p className="text-sm text-gray-400 mb-6">Volumen total de producción</p>
              <ResponsiveContainer width="100%" height={400}>
                <ComposedChart data={datosPolloChart} margin={{ left: 20, right: 20, bottom: 20 }}>
                  ...
                  <Tooltip 
                    ...
                    formatter={(value, name, props) => {
                      const anio = props.payload.anio;
                      return [formatNumber(value) + ' pollos', `Procesados ${anio}`];
                    }}
                  />
